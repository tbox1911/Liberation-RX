...
private _units = [];
SpawnUnitUnits = _units;
publicVariable "SpawnUnitUnits";

SpawnUnitSector = _sector;
publicVariable "SpawnUnitSector";
...
for "_i" from 1 to _amount do {
	...
	private _spawn_position = _positions deleteAt (random (floor (count _positions) - 1));
	(selectRandom _classnames) createUnit [_spawn_position, _grp, 'this setDir (random 360); [this, SpawnUnitSector] spawn building_defence_ai; SpawnUnitUnits pushBack this;', 0.9, 'private']; 
	sleep 1;
