...
player createDiaryRecord ["Table", ["Table", format ["<font color='#ff4000'>-15</font> rank and ammo  :  Killing Prisoners"]]];
player createDiaryRecord ["Table", ["Table", format ["<font color='#ff4000'>-15</font> rank and ammo  :  Killing Civilians"]]];
player createDiaryRecord ["Table", ["Table", format ["<font color='#ff4000'>-10</font> rank and ammo  :  Friendly fire for each wound"]]];
player createDiaryRecord ["Table", ["Table", format ["<font color='#00ff40'>+10</font> rank and ammo  :  Recycle AmmoBox<br/>"]]];
player createDiaryRecord ["Table", ["Table", format ["<font color='#00ff40'>+10</font> rank and ammo  :  Bring Prisoners at HQ"]]];
player createDiaryRecord ["Table", ["Table", format ["<font color='#00ff40'> +5</font> rank and ammo  :  Salvage Wrecks"]]];
player createDiaryRecord ["Table", ["Table", format ["<font color='#00ff40'> +1</font> rank and ammo  :  Kill enemy infantry"]]];
