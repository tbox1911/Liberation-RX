...
light_vehicles = [
	...
	["R3F_KAMAZ_CE_trans",1,25,7,0],
	["R3F_KAMAZ_CE_VPC",1,25,8,GRLIB_perm_inf],
	["R3F_PLFS_A",5,120,12,GRLIB_perm_inf],
	["R3F_PVP_FN_CE",2,65,12,0],
	["R3F_PVP_WASP_CE_COMMANDEMENT",2,75,12,0],
	["R3F_FENNEC_CE",2,25,12,0],
	["R3F_FENNEC_CE_HMG",5,100,12,GRLIB_perm_inf],
	["R3F_FENNEC_CE_GMG",5,125,12,GRLIB_perm_log],
	["R3F_MATV_CE",2,40,12,0],
	["R3F_MATV_CE_HMG",5,120,12,GRLIB_perm_inf],
	["R3F_MATV_CE_GMG",5,145,12,GRLIB_perm_log]
];
...
heavy_vehicles = [
	...
	["R3F_PANDUR_CE",12,650,25,GRLIB_perm_log],
	["B_APC_Tracked_01_AA_F",10,500,20,GRLIB_perm_tank],
	["R3F_MBT52_CE",15,1500,35,GRLIB_perm_tank],
...
air_vehicles = [
	...
	["R3F_AH6_CE",1,50,5,GRLIB_perm_inf],
	["R3F_AH6_CE_ARMED",5,100,10,GRLIB_perm_tank],
	["R3F_LYNX_CE",15,500,10,GRLIB_perm_tank],
	["R3F_LYNX_CE_ARMED",20,1000,30,GRLIB_perm_air],
	["R3F_LYNX_CE_EVASAN",20,1000,30,GRLIB_perm_air],
	["R3F_MERLIN_CE",15,1000,15,GRLIB_perm_air],
