...
_unit forceAddUniform "U_LIB_SOV_Strelok_w";
...
for "_i" from 1 to 5 do {_unit addItemToVest "LIB_5Rnd_762x54";};
for "_i" from 1 to 3 do {_unit addItemToVest "LIB_8Rnd_762x25";};
...
[_unit,"WhiteHead_14","male01su"] call BIS_fnc_setIdentity;
