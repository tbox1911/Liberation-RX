...
// support_vehicles_west
  ...
  // BAF
    ...
    ["UK3CB_BAF_MAN_HX60_Cargo_Green_A",0,logistic_ground_vehicle_price_tier_2,0,GRLIB_perm_inf],
    ["UK3CB_BAF_MAN_HX60_Cargo_Green_B",0,logistic_ground_vehicle_price_tier_2,0,GRLIB_perm_inf],
    ...
    ["UK3CB_BAF_MAN_HX58_Cargo_Green_A",0,logistic_ground_vehicle_price_tier_2,0,GRLIB_perm_inf],
    ["UK3CB_BAF_MAN_HX58_Cargo_Green_B",0,logistic_ground_vehicle_price_tier_2,0,GRLIB_perm_inf]
];
