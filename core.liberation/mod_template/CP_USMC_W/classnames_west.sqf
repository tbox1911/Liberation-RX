...
huron_typename = "CUP_B_UH60M_Unarmed_FFV_MEV_US";  // // to use value from lobby/server.cfg
FOB_typename = "Land_Cargo_HQ_V1_F";
FOB_box_typename = "B_Slingload_01_Cargo_F";
FOB_truck_typename = "CUP_B_MTVR_Ammo_BAF_WOOD";
Respawn_truck_typename = "CUP_B_M113A3_Med_USA";
...
basicweapon_typename = "CUP_LocalBasicWeaponsBox";
...
infantry_units_west = [
	...
	["CUP_B_USMC_Soldier_AR",1,0,0,GRLIB_perm_inf],
	["CUP_B_USMC_Soldier_AT",1,0,0,GRLIB_perm_inf],
	...
	["CUP_B_USMC_Soldier_HAT",1,0,0,GRLIB_perm_tank],
	["CUP_B_USMC_Sniper_M40A3",1,0,0,GRLIB_perm_tank],
	["CUP_B_USMC_Sniper_M107",1,0,0,GRLIB_perm_air],
...
light_vehicles = [
	...
	["CUP_B_nM1037sc_USA_WDL",2,30,2,GRLIB_perm_inf],
	["CUP_B_nM1025_SOV_M2_USA_WDL",3,50,3,GRLIB_perm_inf],
	["CUP_B_nM1025_SOV_Mk19_USA_WDL",3,75,4,GRLIB_perm_inf],
	["CUP_B_M1151_Deploy_WDL_USA",4,100,4,GRLIB_perm_log],
	["CUP_B_M1151_Mk19_WDL_USA",4,125,5,GRLIB_perm_log],
	["CUP_B_M1165_GMV_WDL_USA",4,150,6,GRLIB_perm_log],
	["CUP_B_nM1036_TOW_USA_WDL",6,225,7,GRLIB_perm_log],
	["CUP_B_M1167_WDL_USA",8,300,5,GRLIB_perm_tank],
	["CUP_B_RG31_M2_OD_USA",6,300,7,GRLIB_perm_tank],
	["CUP_B_RG31_Mk19_OD_USA",6,350,8,GRLIB_perm_tank],
	["CUP_B_RG31E_M2_OD_USA",6,375,10,GRLIB_perm_tank]
];

heavy_vehicles = [
	// AA
	["CUP_B_M6LineBacker_USA_W",15,1000,15,GRLIB_perm_air],
	// Arti
	["CUP_B_M1129_MC_MK19_Woodland",45,3000,50,GRLIB_perm_max],
	// Other
	["CUP_B_M113A3_USA",10,400,10,GRLIB_perm_log],
	["CUP_B_M113A3_Reammo_USA",7,300,10,GRLIB_perm_log],
	["CUP_B_M113A3_Repair_USA",7,300,10,GRLIB_perm_log],
	["CUP_B_M1126_ICV_M2_Woodland",15,600,15,GRLIB_perm_log],
	["CUP_B_M1126_ICV_MK19_Woodland",15,700,15,GRLIB_perm_log],
	["CUP_B_M1128_MGS_Woodland",30,2000,25,GRLIB_perm_air],
	["CUP_B_M1135_ATGMV_Woodland",30,2000,25,GRLIB_perm_air],
	["CUP_B_LAV25M240_USMC",20,800,20,GRLIB_perm_tank],
	["CUP_B_M7Bradley_USA_W",20,850,20,GRLIB_perm_tank],
	["CUP_B_M2Bradley_USA_W",35,1500,35,GRLIB_perm_air],
	["CUP_B_M2A3Bradley_USA_W",50,2000,35,GRLIB_perm_max],
	["CUP_B_M1A1SA_Woodland_US_Army",40,3000,40,GRLIB_perm_air],
	["CUP_B_M1A2SEP_TUSK_II_Woodland_US_Army",50,4000,50,GRLIB_perm_max]
];
