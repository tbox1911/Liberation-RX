...
opfor_sentry = "O_T_Soldier_lite_F";
...
opfor_heavygunner = "O_T_Support_MG_F";
...
opfor_sharpshooter = "O_T_Soldier_M_F";
opfor_sniper = "O_T_sniper_F";
opfor_spotter = "O_T_spotter_F";
...
opfor_recyclable = [
	...
	["O_T_T_VTOL_02_vehicle_F",20,round (2500 / GRLIB_recycling_percentage),20],
	["O_T_T_VTOL_02_infantry_F",20,round (2500 / GRLIB_recycling_percentage),20]
];
