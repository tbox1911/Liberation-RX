...
opfor_recyclable = [
	...
	["CUP_O_BTR40_MG_TKM",1,round (60 / GRLIB_recycling_percentage),2],
	...
	["CUP_O_T55_TK",1,round (70 / GRLIB_recycling_percentage),2],
	["CUP_O_T72_TKA",1,round (80 / GRLIB_recycling_percentage),2]
