...
opfor_sentry = "CUP_B_USMC_SpecOps_SD_des";
opfor_rifleman = "CUP_B_USMC_Soldier_des";
opfor_grenadier = "CUP_B_USMC_Soldier_GL_des";
opfor_squad_leader = "CUP_B_USMC_Soldier_SL_des";
opfor_team_leader = "CUP_B_USMC_Soldier_TL_des";
opfor_marksman = "CUP_B_USMC_Soldier_Marksman_des";
opfor_machinegunner = "CUP_B_USMC_Soldier_AR_des";
opfor_heavygunner = "CUP_B_USMC_Soldier_MG_des";
opfor_medic = "CUP_B_USMC_Medic_des";
opfor_rpg = "CUP_B_USMC_Soldier_LAT_des";
opfor_at = "CUP_B_USMC_Soldier_AT_des";
opfor_aa = "CUP_B_USMC_Soldier_AA_des";
opfor_officer = "CUP_B_USMC_Officer_des";
opfor_sharpshooter = "CUP_B_USMC_Sniper_M40A3_des";
opfor_sniper = "CUP_B_USMC_Sniper_M107_des";
opfor_spotter = "CUP_B_USMC_Spotter_des";
opfor_engineer = "CUP_B_USMC_Engineer_des";
opfor_paratrooper = "CUP_B_BAF_Soldier_Paratrooper_DDPM";
opfor_mrap = "CUP_B_M1151_USA";
opfor_mrap_hmg = "CUP_B_M1151_Deploy_USA";
opfor_mrap_gmg = "CUP_B_M1151_Mk19_USA";
opfor_transport_helo = "CUP_B_MH47E_USA";
opfor_transport_truck = "CUP_B_MTVR_USA";
opfor_fuel_truck = "CUP_B_MTVR_Refuel_USA";
opfor_ammo_truck = "CUP_B_MTVR_Ammo_USA";
