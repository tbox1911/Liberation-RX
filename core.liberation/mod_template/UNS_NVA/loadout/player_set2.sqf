...
for "_i" from 1 to 3 do {_unit addItemToVest "uns_ak47mag";};
for "_i" from 1 to 2 do {_unit addItemToBackpack "FirstAidKit";};
for "_i" from 1 to 2 do {_unit addItemToBackpack "uns_ak47mag";};
for "_i" from 1 to 2 do {_unit addItemToBackpack "uns_t67gren";};
for "_i" from 1 to 2 do {_unit addItemToBackpack "uns_rdg2";};
