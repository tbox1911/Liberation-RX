GRLIB_FOB_Defense = [
    ...
    ["Medium Defense 2", "scripts\fob_templates\defense4.sqf", 80],
    ["Large Defense 1", "scripts\fob_templates\defense5.sqf", 100],
    ["Large Defense 2", "scripts\fob_templates\defense6.sqf", 100]    
];
