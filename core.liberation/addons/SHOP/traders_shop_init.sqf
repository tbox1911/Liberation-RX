...
SHOP_list = light_vehicles + strong_light_vehicles + heavy_vehicles + strong_heavy_vehicles + air_vehicles + fast_air_vehicle + support_vehicles + support_crates + opfor_recyclable + ind_recyclable + loot_crates;
