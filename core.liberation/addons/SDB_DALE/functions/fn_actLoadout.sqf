...
private _actionCond = "(round (getPos _target select 2) <= 0) && (driver _target isEqualTo _this) && (speed vehicle _target < 1) && ([player, 'REAMMO', 30, true] call F_check_near || [_unit, 'LHD', 200] call F_check_near)";
