...
systemchat format ["DBG: Debug level: %1", GRLIB_debug_level];
if (GRLIB_debug_level >= 1) then {
	[] execVM "scripts\client\ui\intro.sqf";
	[] execVM "scripts\client\spawn\redeploy_manager.sqf";
	if (GRLIB_debug_level >= 2) then {
