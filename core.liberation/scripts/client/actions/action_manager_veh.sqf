...
while {true} do {
...

	{
		...
		_vehicle addAction ["<t color='#9F0000'>" + localize "STR_STICKY_BOMB" + "</t> <img size='1' image='res\skull.paa'/>", "scripts\client\actions\do_sticky_bomb.sqf","",-509,false,true,"","[_target, _this] call GRLIB_checkAction_Sticky", GRLIB_ActionDist_3];
