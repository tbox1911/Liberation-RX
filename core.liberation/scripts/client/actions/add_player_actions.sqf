...
// Onboard Ship
player addAction ["<t color='#00206F'>" + localize "STR_ONBOARD_SHIP" + "</t> <img size='1' image='res\ui_deployfob.paa'/>",{ [getPosASL player] spawn do_onboard },"",-981,false,true,"","call GRLIB_checkOnboardShip"];
