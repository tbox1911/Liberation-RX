...
while { true } do {
...

    {
        ...
        _vehicle addAction ["<t color='#FFFF00'>" + localize "STR_ACTION_UNLOAD_ONE_BOX" + "</t> <img size='1' image='res\ui_unload.paa'/>","scripts\client\ammoboxes\do_unload_truck.sqf","one",-401,false,true,"","[_target, _this] call GRLIB_checkAction_UnloadBox", GRLIB_ActionDist_10];
