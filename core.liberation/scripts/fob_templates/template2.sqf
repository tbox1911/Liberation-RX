_objects_to_build = [
    ...
    [ opfor_mrap_gmg, [-13.81, -17.08, 0.01], 254.24 ],
    ...
    [ opfor_patrol, [17.02, -16.67, 0], 359.51 ],
    ...
    [ opfor_patrol, [-18.01, 19.63, 0], 180.02 ],
...
[ "Model 2", _objects_to_build, _objectives_to_build, _defenders_to_build, _base_corners ]