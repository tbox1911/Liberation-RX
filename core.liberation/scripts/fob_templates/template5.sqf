...
private _objectives_to_build = [
    [opfor_fuel_container,[-16.82,17.67,0],47.97],
    [opfor_ammo_container,[-0.42,-3.26,0],104.66],
    [opfor_fuel_container,[-9.52,-0.47,0],295.86],
...
["Model 5", _objects_to_build, _objectives_to_build, _defenders_to_build, _base_corners];