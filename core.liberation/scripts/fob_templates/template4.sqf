private _objects_to_build = [
    ...
    [opfor_mrap_gmg,[-20.26,-3.22,0.01],359.22],
    ["Land_HBarrierBig_F",[1.23,20.94,0],0.69],
    [opfor_patrol,[16.23,15.36,0],269.81],
...
private _objectives_to_build = [
    [opfor_fuel_truck,[1.41,11.53,0],271.88],
    [opfor_ammo_truck,[-1.45,-13.1,0],357.37],
    [opfor_ammo_truck,[-7.67,-13,0],0.71]
];
