...
_objects_to_build = [
    ...
    ["Land_HBarrierBig_F",[-4,-30,0],0],
    ["Land_HBarrierBig_F",[-11,-30,0],0],
    [opfor_patrol,[-10,-26,0],0],
    [opfor_hq,[4,-20,0],0],
    [opfor_house,[-9,24,0],0],
    [opfor_house,[-1,24,0],0],
    [opfor_patrol,[10,24,0],180],
...
[ "Model 1", _objects_to_build, _objectives_to_build, _defenders_to_build, _base_corners ]