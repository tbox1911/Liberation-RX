...
_waitUntilSuccessCondition = {
	_ret = false;
	private _barrels = [_man1 nearEntities [waterbarrel_typename, 20], {isNull R3F_LOG_joueur_deplace_objet && isNil {_x getVariable "R3F_LOG_objets_charges"} && !(_x getVariable ['R3F_LOG_disabled', false])}] call BIS_fnc_conditionalSelect;
