...
switch (_boxType) do
{
	case "mission_USLaunchers":
	{
		...
		[
			...
			["wep", ["launch_RPG32_F", "launch_NLAW_F", "launch_O_Titan_short_F"], RANDOM_BETWEEN(2,5), RANDOM_BETWEEN(1,2)],
			["wep", "launch_O_Titan_F", RANDOM_BETWEEN(1,2), RANDOM_BETWEEN(1,2)],
