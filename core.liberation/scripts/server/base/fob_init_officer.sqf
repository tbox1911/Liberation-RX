...
private _map = createVehicle ["MapBoard_seismic_F", zeropos, [], 100, "CAN_COLLIDE"];
...
if !(surfaceIsWater _fob_pos) then {
	...
	_lamp1 = createVehicle ["Land_LampStreet_02_amplion_F", zeropos, [], 100, "CAN_COLLIDE"];
	...
	private _lampPos = _fob_pos vectorAdd ([[10, 7, 0], -_map_dir] call BIS_fnc_rotateVector2D);
	_lamp2 = createVehicle ["Land_LampStreet_02_triple_F", zeropos, [], 100, "CAN_COLLIDE"];
