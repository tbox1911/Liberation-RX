...
if ( combat_readiness >= bg_readiness_min ) then { _planes_number = 2; };
if ( combat_readiness >= bg_readiness_min*2 ) then { _planes_number = 3; };
if ( combat_readiness >= bg_readiness_min*2.5 ) then { _planes_number = 4; };
...
for "_i" from 1 to _planes_number do {
	...
	_newvehicle setSkill skill_air_vehicles_planes;
