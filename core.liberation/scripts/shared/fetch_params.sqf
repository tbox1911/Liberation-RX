...
// Selectable
GRLIB_introduction = ["Introduction",1] call lrx_getParamValue;
GRLIB_deployment_cinematic = ["DeploymentCinematic",1] call lrx_getParamValue;
GREUH_allow_mapmarkers = ["MapMarkers",0] call lrx_getParamValue;
GREUH_allow_platoonview = ["PlatoonView",0] call lrx_getParamValue;
GREUH_allow_nametags = ["NameTags",0] call lrx_getParamValue;
GRLIB_unitcap = ["Unitcap",1] call lrx_getParamValue;
GRLIB_fancy_info = ["FancyInfo",2] call lrx_getParamValue;
GRLIB_hide_opfor = ["HideOpfor",1] call lrx_getParamValue;
GRLIB_show_blufor = ["ShowBlufor",2] call lrx_getParamValue;
GRLIB_thermic = ["Thermic",1] call lrx_getParamValue;
GRLIB_fob_type = [ "FobType",0] call lrx_getParamValue;
GRLIB_huron_type = [ "HuronType", 0] call lrx_getParamValue;
GRLIB_naval_type = [ "NavalFobType", 0] call lrx_getParamValue;
GRLIB_max_fobs = [ "MaxFobs",3] call lrx_getParamValue;
GRLIB_max_outpost = [ "MaxOutpost",4] call lrx_getParamValue;
GRLIB_passive_income = ["PassiveIncome",0] call lrx_getParamValue;
GRLIB_passive_delay = ["PassiveIncomeDelay",1200] call lrx_getParamValue;
GRLIB_passive_ammount = ["PassiveIncomeAmmount",300] call lrx_getParamValue;
GRLIB_resources_multiplier = ["ResourcesMultiplier",1] call lrx_getParamValue;
GRLIB_disable_death_chat = ["DeathChat", 1] call lrx_getParamValue;
GRLIB_mod_preset_west = ["ModPresetWest", 0] call lrx_getParamValue;
GRLIB_mod_preset_east = ["ModPresetEast", 0] call lrx_getParamValue;
GRLIB_enable_arsenal = ["EnableArsenal",1] call lrx_getParamValue;
GRLIB_filter_arsenal = ["FilterArsenal",1] call lrx_getParamValue;
GRLIB_forced_loadout = ["ForcedLoadout",1] call lrx_getParamValue;
GRLIB_free_loadout = ["FreeLoadout",0] call lrx_getParamValue;
...
GRLIB_squad_size = ["SquadSize",2] call lrx_getParamValue;
GRLIB_max_squad_size = ["MaxSquadSize",6] call lrx_getParamValue;
GRLIB_max_spawn_point = ["MaxSpawnPoint",3] call lrx_getParamValue;
...
GRLIB_cleanup_vehicles = ["CleanupVehicles",1800] call lrx_getParamValue;
GRLIB_autosave_timer = ["AutoSave",1800] call lrx_getParamValue;
GRLIB_param_wipe_keepscore = ["KeepScore",0] call lrx_getParamValue;
GRLIB_respawn_timer = ["Respawn",20] call lrx_getParamValue;
GRLIB_respawn_cooldown = ["RespawnCD",0] call lrx_getParamValue;
GRLIB_kick_idle = ["KickIdle",0] call lrx_getParamValue;
GRLIB_server_persistent = ["Persistent",0] call lrx_getParamValue;
GRLIB_air_support = ["AirSupport",1] call lrx_getParamValue;
GRLIB_despawn_tickets = ["SectorDespawn",72] call lrx_getParamValue;
