...
GRLIB_passive_delay = ["PassiveIncomeDelay",0] call _lrx_getParamValue;
GRLIB_passive_ammount = ["PassiveIncomeAmmount",0] call _lrx_getParamValue;
...
if ( !GRLIB_RHS_enabled && ["RHS_", [GRLIB_mod_west, GRLIB_mod_east]] call _startsWithMultipleInv) then { abort_loading = true };
