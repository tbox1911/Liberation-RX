...
support_vehicles = support_vehicles_west + [
	...
	[fuelbarrel_typename,0,round(10 / GRLIB_recycling_percentage),0,GRLIB_perm_inf],
	...
	[waterbarrel_typename,0,round(10 / GRLIB_recycling_percentage),0,GRLIB_perm_inf],
	[foodbarrel_typename,0,round(10 / GRLIB_recycling_percentage),0,GRLIB_perm_inf]
