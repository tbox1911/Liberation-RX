...
F_getFob = compileFinal preprocessFileLineNumbers "scripts\shared\functions\F_getFob.sqf";
...
F_playSound = compileFinal preprocessFileLineNumbers "scripts\shared\functions\F_playSound.sqf";
