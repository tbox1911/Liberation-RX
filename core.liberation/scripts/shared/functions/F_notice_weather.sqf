...
_msg = _msg + format ["<t color='#FFFFFF' size='1.0'>The risk of Rain is <t color='#A0A0A0'>%1</t></t><br/>", round rain];
_msg = _msg + format ["<t color='#FFFFFF' size='1.0'>The Fog level is <t color='#808080'>%1</t></t><br/>", round fog];
