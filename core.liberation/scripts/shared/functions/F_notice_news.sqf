...
_msg = _msg + format ["<t color='#FFFFFF' size='1.0'>There's actually <t color='#000080'>%1</t> players on the Server.</t><br/>", count (AllPlayers - (entities "HeadlessClient_F"))];
_msg = _msg + format ["<t color='#FFFFFF' size='1.0'>Our forces control <t color='#000080'>%1</t> Sectors.</t><br/>", count blufor_sectors];
_msg = _msg + format ["<t color='#FFFFFF' size='1.0'>the Enemy still control <t color='#800000'>%1</t> Sectors.</t><br/><br/>", count opfor_sectors];
