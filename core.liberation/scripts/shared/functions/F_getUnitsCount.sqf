...
_infantrycount = _infantrycount + ( GRLIB_side_civilian countSide ( [ _position nearEntities [ "Man", _distance] , { lifeState _x != 'incapacitated' && {_x getVariable ['PAR_soliders', false]} } ] call BIS_fnc_conditionalSelect ) );
