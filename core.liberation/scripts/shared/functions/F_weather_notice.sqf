...
private _datestring = format ["<t color='#000080'>%1%2:%3%4</t>", _leadingzero_hour, date select 3, _leadingzero_minute, date select 4];
private _msg = format ["<t color='#4BC9B0' shadow='2' size='1.75'>Today's Weather Info</t><br/>"];
_msg = _msg + "<t color='#777777'>------------------------------</t><br/>";
_msg = _msg + format ["Latest fresh news at: %1<br/><br/>", _datestring];
...
_msg = _msg + format ["<t color='#FFFFFF' size='1.0'>The risk of Rain is <t color='#A0A0A0'>%1</t></t><br/>", rain];
_msg = _msg + format ["<t color='#FFFFFF' size='1.0'>The Fog level is <t color='#808080'>%1</t></t><br/>", fog];
