...
private _liste_vehicules_connus = [];
...
private _liste_statiques_connus = [];
...
private _liste_statiques_cycle_precedent = [];
...
private _compteur_cyclique = 0;
private _seuil_nb_statiques_avant_purge = 150;
private _seuil_nb_vehicules_avant_purge = 150;
