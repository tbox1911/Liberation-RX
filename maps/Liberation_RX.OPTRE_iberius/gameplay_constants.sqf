GRLIB_save_key = "GREUH_LIBERATION_OPTRE_IBERIUS_SAVEGAME_PSK"; // change this value if you want different savegames on different map
...
GRLIB_mod_west = "OPTRE";
GRLIB_mod_east = "OPTRE";