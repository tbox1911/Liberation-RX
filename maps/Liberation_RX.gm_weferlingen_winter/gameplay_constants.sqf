GRLIB_save_key = "GREUH_LIBERATION_WEFERLINGEN_WIN_SAVEGAME_PSK"; // change this value if you want different savegames on different map
...
GRLIB_mod_west = "GM_WEST_WINT";
GRLIB_mod_east = "GM_EAST_WINT";