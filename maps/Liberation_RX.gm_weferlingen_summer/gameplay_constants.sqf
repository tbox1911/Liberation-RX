GRLIB_save_key = "GREUH_LIBERATION_WEFERLINGEN_SAVEGAME_PSK"; // change this value if you want different savegames on different map
...
GRLIB_mod_preset_west = 3;
GRLIB_mod_preset_east = 4;